...
#include "turtle_interfaces/msg/detail/turtle__functions.h"  // turtle_array
  ...
  // Field name: turtle_array
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, Turtle
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: turtle_array
  {
    ...
    if (ros_message->turtle_array.data) {
      turtle_interfaces__msg__Turtle__Sequence__fini(&ros_message->turtle_array);
    }
    if (!turtle_interfaces__msg__Turtle__Sequence__init(&ros_message->turtle_array, size)) {
